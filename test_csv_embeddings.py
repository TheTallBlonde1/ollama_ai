...
def get_vector_store(file_path : str, model : str, base_url : str) -> Chroma:
    ...
    return Chroma.from_documents(documents=all_splits, embedding=OllamaEmbeddings(model=model, base_url=base_url), persist_directory="chromadb")
...
if __name__ == "__main__":
    question = "What are the biggest Job Title's?"
    file_path = r".\data\test_csv_data.csv"
